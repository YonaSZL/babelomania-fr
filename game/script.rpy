...
##Tabitha
define ta = Character(_("Tabitha"), what_prefix='{cps=21}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled")
define ta_x = Character(_("?????"), what_prefix='{cps=21}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled")
define ta_n = Character(_("Tabitha"), what_suffix='{cps=21}\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled")
define ta_st = Character(_("Tabitha"), what_prefix='{cps=21}{u}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled")
