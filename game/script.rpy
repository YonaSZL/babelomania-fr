...
##Mira
define mi = Character(_("Mira Badeaux"), what_prefix='\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled")
...
define mi_i = Character(_("Mira Badeaux"), what_prefix='{i}', image="mira", ctc="ctc_blink", ctc_position="nestled")
define mi_n = Character(_("Mira Badeaux"), what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled")
define mi_st = Character(_("Mira Badeaux"), what_prefix='{u}\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled")
