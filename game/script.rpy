...
##Mira
define mi = Character(_("Mira Zurawski"), what_prefix='\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_x = Character(_("?????"), what_prefix='\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_xi = Character(_("?????"), what_prefix='{i}', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_i = Character(_("Mira Zurawski"), what_prefix='{i}', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_n = Character(_("Mira Zurawski"), what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_st = Character(_("Mira Zurawski"), what_prefix='{u}\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
define mi_nst = Character(_("?????"), what_prefix='{u}\"', what_suffix='\"', image="mira", ctc="ctc_blink", ctc_position="nestled", callback=mira_beep)
