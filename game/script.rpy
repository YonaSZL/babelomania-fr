...
##Tabitha
define ta = Character(_("Tabitha"), what_prefix='{cps=21}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define ta_x = Character(_("?????"), what_prefix='{cps=21}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define ta_n = Character(_("Tabitha"), what_suffix='{cps=21}\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define ta_st = Character(_("Tabitha"), what_prefix='{cps=21}{u}\"', what_suffix='\"', image="tabitha", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
...
##Francesco
define fr = Character(_("Francesco Colombo"), what_prefix='\"', what_suffix='\"', image="francesco", ctc="ctc_blink", ctc_position="nestled", callback=shigeo_beep)
define fr_x = Character(_("?????"), what_prefix='\"', what_suffix='\"', image="francesco", ctc="ctc_blink", ctc_position="nestled", callback=shigeo_beep)
define fr_n = Character(_("Francesco Colombo"), what_suffix='\"', image="francesco", ctc="ctc_blink", ctc_position="nestled", callback=shigeo_beep)
define fr_xst = Character(_("?????"), what_prefix='{u}\"', what_suffix='\"', image="francesco", ctc="ctc_blink", ctc_position="nestled", callback=shigeo_beep)
define fr_st = Character(_("Francesco Colombo"), what_prefix='{u}\"', what_suffix='\"', image="francesco", ctc="ctc_blink", ctc_position="nestled", callback=shigeo_beep)
...
##Gaspard
define ga = Character(_("Gaspard Faucigny"), what_prefix='\"', what_suffix='\"', image="gaspard", ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
define ga_x = Character(_("?????"), what_prefix='\"', what_suffix='\"', image="gaspard", ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
define ga_n = Character(_("Gaspard Faucigny"), what_suffix='\"', image="gaspard", ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
define ga_i = Character(_("Gaspard Faucigny"), what_prefix='{i}', image="gaspard", ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
define ga_st = Character(_("Gaspard Faucigny"), what_prefix='{u}\"', what_suffix='\"', image="gaspard", ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
...
##Minor Characters
define tb_n = Character(_("Academic Invitee"), what_prefix='\"', what_suffix='\"', ctc="ctc_blink", ctc_position="nestled", callback=habiki_beep)
define tb_n2 = Character(_("Fashionable Invitee"), what_prefix='\"', what_suffix='\"', ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)

##Delphine
define de = Character(_("Delphine Badeaux"), what_prefix='\"', what_suffix='\"', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define de_x = Character(_("?????"), what_prefix='\"', what_suffix='\"', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define de_xi = Character(_("?????"), what_prefix='{i}', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define de_i = Character(_("Delphine Badeaux"), what_prefix='{i}', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define de_n = Character(_("Delphine Badeaux"), what_suffix='\"', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
define de_st = Character(_("Delphine Badeaux"), what_prefix='{u}\"', what_suffix='\"', image="delphine", ctc="ctc_blink", ctc_position="nestled", callback=amina_beep)
