...
define gui.text_font = gui.preference("font", "gui/font/LinLibertine_R.ttf")
# The text font for buttons
define gui.interface_text_font = gui.preference("interface_font", "gui/font/Klotee.ttf")
# The default size of in-game text
define gui.text_size = gui.preference("size", 27)
# The font for character names
define gui.name_text_font = gui.preference("name_font", "gui/font/Sok Brubah.ttf")
...
style scrollbar:
    ysize 18
    base_bar Frame("gui/scrollbar/horizontal_[prefix_]bar.png", 30, 6,30, 6, tile=False)
...
style vscrollbar:
    xsize 18
    #base_bar Frame("gui/scrollbar/vertical_[prefix_]bar.png", 6, 30,6, 30, tile=False)
    thumb Frame("gui/scrollbar/vertical_[prefix_]thumb.png", 6, 30,6, 30, tile=False)
    unscrollable 'hide'
...
style slider:
    ...
    thumb_offset 12
    left_gutter 25 right_gutter 25
