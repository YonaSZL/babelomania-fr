...
translate french story_00_invitation_ca8741bb:
    ...
    nvl clear
    d "Instructions pour se rendre à la réception :"
...
translate french story_00_bathroom_break_b827b6ce:
    ...
    sh_i sad "(Et seulement du marié.)"
...
translate french story_00_bathroom_encounters_385dfa0c:
    ...
    sh_i frown "(Quand a-t-il été fabriqué ?{w=0.5} Et par qui ?)"
...
translate french story_00_bathroom_return_cfe6349c:
    ...
    sh nulla ".{w=0.3}.{w=0.3}.{w=0.5} Vous savez, étant donné que votre sac à boulons a failli m'attaquer, je pense que des excuses seraient une meilleure introduction que des insultes voilées."
...
translate french story_00_bathroom_return_40551126:
    ...
    ha_x nulla "Mon Dieu, quel jeune homme si grossier.{w=0.3} Traiter ma Tabitha de sac à boulons..."
...
translate french story_00_meet_gaspard_9ab0c4d0:
    ...
    ga_x nulla "<Désolé de vous avoir appelé si soudainement mais je crois que nous nous sommes croisés plus tôt ?>"
...
translate french story_00_meet_amina_8e5c1904:
    ...
    am nulla "Vraiment ?{w=0.3} Mais Gaspard-"
