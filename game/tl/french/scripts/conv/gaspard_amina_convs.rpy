...
translate french gaspmina_01_gaspardamina_68b52c8e:
    ...
    am nulla "Ce qui signifie...{w=0.5} Que celui qui nous a mis ici n'en est pas après l'argent."
...
translate french gaspmina_01_gaspardamina_b4cef8d0:
    ...
    sh neutral sweat ".{w=0.3}.{w=0.3}.{w=0.5} J'en ai bien peur."
...
translate french gaspmina_01_code_c0a48b6c:
    ...
    am nulla "Avec un code à six chiffres.{w=0.3} Quand nous avons quitté la pièce dans laquelle nous nous sommes réveillés, la porte s'est verrouillée derrière nous et ça n'a pas fonctionné sur l'autre porte...{w=0.5} Alors je me suis dit, autant essayer."
...
translate french gaspmina_01_code_f8b73613:
    ...
    sh neutral "Et ça a fonctionné...{w=0.5} Une note avec le code nécessaire pour ouvrir la porte de cette pièce.{w=0.3} Et tu l'as trouvée traînant comme ça ?"
