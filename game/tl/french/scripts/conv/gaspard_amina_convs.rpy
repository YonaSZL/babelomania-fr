...
translate french gaspmina_01_shigeo_70186b5e:
    ...
    ga nulla "<Qu'est-ce que tu faisais, là-dedans ?>"
...
translate french gaspmina_01_shigeo_0e117604:
    ...
    am nulla "Tout comme nous...{w=0.5} Quelle est la dernière chose dont tu te souviens ?"
...
translate french gaspmina_01_shigeo_6076741e:
    ...
    sh frown "Le mariage.{w=0.3} Le début de la vidéo, projetée sur l'écran mural...{w=0.5} Puis, plus rien."
...
translate french gaspmina_01_shigeo_5b15dd61:
    ...
    sh neutral "La prochaine chose que je sais, c'est que je me suis réveillé, allongé sur ce canapé.{w=0.3} Et vous deux ?"
...
translate french gaspmina_01_shigeo_06590dc6:
    ...
    am nulla "C'est à peu près la même histoire...{w=0.5} Nous nous sommes réveillés étendus sur le sol dans une pièce voisine."
...
translate french gaspmina_01_shigeo_d02c5549:
    ...
    am nulla "La dernière chose dont je me souviens, c'était aussi de cette vidéo.{w=0.3} Je veux dire..."
...
translate french gaspmina_01_shigeo_b3179dfc:
    ...
    am nulla "Non...{w=0.5} Je veux dire, je me souviens que c'est ce que nous faisions mais...{w=0.5} Je ne me souviens pas vraiment de {nw}"
...
translate french gaspmina_01_shigeo_5a1a9851:
    ...
    ga nulla "<Tu ne te souviens pas de la vidéo elle-même... ?>"
...
translate french gaspmina_01_shigeo_e09e561d:
    ...
    sh surprise "Maintenant que tu le dis...{w=0.5} Tu as raison, je ne me souviens pas de ça, non plus."
...
translate french gaspmina_01_shigeo_86d7610a:
    ...
    sh frown "Et pourtant, je suis sûr d'en avoir vu au moins quelques secondes avant...{w=0.5} L'évanouissement."
...
translate french gaspmina_01_shigeo_2711390b:
    ...
    am nulla "C'est assez étrange...{w=0.5} Gaspard, et toi ?"
...
translate french gaspmina_01_shigeo_c47bcc63:
    ...
    ga nulla "<Si aucun de vous ne s'en souvient et que jusqu'à présent nous avons tous eu les mêmes expériences, qu'est-ce qui te fait penser que c'est différent pour moi ?>"
...
translate french gaspmina_01_shigeo_bdd96f52:
    ...
    am nulla "Je...{w=0.5} Je vérifiais juste."
...
translate french gaspmina_01_gaspardamina_965cf698:
    ...
    sh neutral -sweat "Il y a combien de temps que vous vous êtes réveillés ?{w=0.3} Avez-vous rencontré quelqu'un d'autre ?"
...
translate french gaspmina_01_gaspardamina_ff947377:
    ...
    ga nulla "<Personne.{w=0.3} Je me suis réveillé en premier, la pièce était...{w=0.5} Semblable à celle-ci.{w=0.3} Un petit bureau avec un mobilier affreux...{w=0.5} Sans aucun doute le bâtiment Taishō.>"
...
translate french gaspmina_01_gaspardamina_7ff399cb:
    ...
    am nulla "Je me suis réveillé peu de temps après.{w=0.3} Obscurité totale, les lumières ne fonctionnent pas.{w=0.3} Pareil pour le couloir principal, bien qu'il y ait de la lumière qui vient de l'extérieur, par la fenêtre."

# game/scripts/conv/gaspard_amina_convs.rpy:129
...
translate french gaspmina_01_gaspardamina_836f1489:
    ...
    ga nulla "<Ils ont déconné avec le...{w=0.5} Quoi ?{w=0.3} C'est quoi ce mot ?>"
...
translate french gaspmina_01_gaspardamina_2c926c67:
    ...
    sh surprise "Ah ?{w=0.3} Uhm, le...{w=0.5} Bon sang, je ne connais pas le mot en français..."
...
translate french gaspmina_01_gaspardamina_fbf385d3:
    ...
    sh neutral "Je suis...{w=0.5} Désolé, mais je ne le parle pas assez couramment pour articuler correctement mes pensées dans une telle situation."

# game/scripts/conv/gaspard_amina_convs.rpy:138
translate french gaspmina_01_gaspardamina_60330833:
    ...
    am nulla "Gaspard, c'est bon.{w=0.3} Je peux traduire s'il y a quelque chose que tu ne comprends pas."

# game/scripts/conv/gaspard_amina_convs.rpy:140
translate french gaspmina_01_gaspardamina_2ce149b7:

    # ga nulla "<Oh, thank you {i}so{/i} much!{w=0.3} That's not the point!>"
    ga nulla "<Oh, merci {i}beaucoup{/i} !{w=0.3} Ce n'est pas le problème !>"
...
# game/scripts/conv/gaspard_amina_convs.rpy:143
translate french gaspmina_01_gaspardamina_2e606abf:
    ...
    ga nulla "<Pourquoi dois-je être celui qui l'accommode ?!{w=0.3} Nous sommes en France, bon sang !{w=0.3} Parlez la langue si nous devons vraiment souffrir...>"

# game/scripts/conv/gaspard_amina_convs.rpy:146
translate french gaspmina_01_gaspardamina_a2f179f3:

    # ga nulla "<Suffer...{w=0.5} Aaaah...>"
    ga nulla "<Souffrir...{w=0.5} Aaaah...>"
...
translate french gaspmina_01_gaspardamina_e65544ec:
    ...
    sh neutral "<Nous sommes dans une situation difficile et étrange.{w=0.3} Être stressé est parfaitement normal.>"

# game/scripts/conv/gaspard_amina_convs.rpy:151
translate french gaspmina_01_gaspardamina_a58b8ddd:
    ...
    sh frown "<Je comprends que tu veuilles que les choses te semblent familières.{w=0.3} En sécurité.{w=0.3} Mais comme c'est une situation difficile, je dois parler du mieux que je peux.>"
...
translate french gaspmina_01_gaspardamina_10812d52:
    ...
    sh neutral "<Et je ne suis pas assez bon dans ta langue pour faire ça.{w=0.3} Mais tu es assez bon dans la mienne, n'est-ce pas ?{w=0.3} Tu me l'as dit plus tôt.>"

# game/scripts/conv/gaspard_amina_convs.rpy:154
translate french gaspmina_01_gaspardamina_fb5bf459:

    # ga nulla "<Whatever...{w=0.5} I don't get why you're here too, anyway.>"
    ga nulla "<Peu importe...{w=0.5} Je ne comprends pas pourquoi tu es là aussi, de toute façon.>"
...
translate french gaspmina_01_gaspardamina_da22c78a:
    ...
    sh neutral "Je me suis posé la même question...{w=0.5} Je peux deviner qu'entre nous deux, n'importe quel kidnappeur serait en mesure de demander une grosse somme pour ton retour sain et sauf."
...
translate french gaspmina_01_gaspardamina_53cd6978:
    ...
    sh surprise "Pas tant pour moi.{w=0.3} Je suis qu'un fonctionnaire, débutant, et mes deux parents sont de la classe moyenne."
...
translate french gaspmina_01_gaspardamina_6d4e05c2:
    ...
    ga nulla "<Oh, comme si ces types comprenaient ce genre de choses.{w=0.3} Vous étiez à la même réception et à la même table, ils ont juste attrapé qui ils pouvaient.>"
...
translate french gaspmina_01_gaspardamina_08c344b7:
    ...
    sh neutral ".{w=0.3}.{w=0.3}.{w=0.5} Peut-être."
...
translate french gaspmina_01_code_a2d92a77:
    ...
    sh neutral -sweat "Est-ce que tu vas bien ?{w=0.3} Physiquement, je veux dire.{w=0.3} Tu te jetais contre la porte."
...
translate french gaspmina_01_code_04171ca6:
    ...
    ga nulla "<C'était moi, oui.{w=0.3} Je vais bien.>"

# game/scripts/conv/gaspard_amina_convs.rpy:174
translate french gaspmina_01_code_07645761:
    ...
    am nulla "<Essaies juste de ne pas fatiguer ton côté droit, pendant un petit moment.>"
...
# game/scripts/conv/gaspard_amina_convs.rpy:176
translate french gaspmina_01_code_dead1de9:
    ...
    sh surprise "Je ne savais pas quoi penser pendant un moment, là.{w=0.3} D'abord tu as fait claquer la poignée, puis tu as essayé de casser la porte, et puis tu as juste...{w=0.5} Tu l'as ouverte.{w=0.3} Comment ?"
...
translate french gaspmina_01_code_67d65e34:
    ...
    am nulla "Comme cette pièce est assez identique à celle dans laquelle nous nous sommes réveillés, porte et tout, j'ai pensé qu'ils fonctionnaient de la même manière.{w=0.3} Peut être qu'elle s'ouvre de l'intérieur mais il faut un {nw}"
...
translate french gaspmina_01_code_c8b79ea3:
    ...
    extend "{b}code{/b} pour les ouvrir de l'extérieur."

# game/scripts/conv/gaspard_amina_convs.rpy:181
translate french gaspmina_01_code_b1c9172c:

    # sh surprise "A code, you say?"
    sh surprise "Un code, tu dis ?"
...
translate french gaspmina_01_code_4fa59c47:
    ...
    ga nulla "<Ouais.{w=0.3} Il y a un clavier sur le mur, à l'extérieur.>"

# game/scripts/conv/gaspard_amina_convs.rpy:183
translate french gaspmina_01_code_fe43ecc9:
    ...
    sh neutral "Je vois...{w=0.5} Je dois dire que vous avez eu beaucoup de chance de pouvoir deviner."
...
translate french gaspmina_01_code_eedf54ae:
    ...
    am nulla "Eh bien, nous ne l'avons pas fait...{w=0.5} Pas le code lui-même, en tout cas."

# game/scripts/conv/gaspard_amina_convs.rpy:188
translate french gaspmina_01_code_7493c4ee:

    # am nulla "I just went off a hunch based on {b}this{/b}."
    am nulla "Je me suis juste basée sur une intuition par rapport à {b}ceci{/b}."

# game/scripts/conv/gaspard_amina_convs.rpy:189
...
translate french gaspmina_01_code_338ac35f:
    ...
    am nulla "Avec un code à huit chiffres.{w=0.3} Quand nous avons quitté la pièce dans laquelle nous nous sommes réveillés, la porte s'est verrouillée derrière nous et ça n'a pas fonctionné sur l'autre porte...{w=0.5} Alors je me suis dit, autant essayer."
...
translate french gaspmina_01_code_2dec4271:
    ...
    sh neutral "Une note avec le code nécessaire pour ouvrir la porte de cette pièce.{w=0.3} Et tu l'as trouvée traînant comme ça ?"

# game/scripts/conv/gaspard_amina_convs.rpy:197
translate french gaspmina_01_code_27868814:

    # ga nulla "<No.{w=0.3} I found it in my pocket when I grabbed my {b}phone{/b}.>"
    ga nulla "<Non.{w=0.3} Je l'ai trouvée dans ma poche quand j'ai attrapé mon {b}téléphone{/b}.>"

# game/scripts/conv/gaspard_amina_convs.rpy:201
translate french gaspmina_01_code_37394886:

    # sh shock "Wait, your...{w=0.5} Your phone?!"
    sh shock "Attends, ton...{w=0.5} Ton téléphone ?!"
...
translate french gaspmina_01_phone_8e14c07b:
    ...
    sh shock "Tu viens de dire que tu as trouvé cette note avec ton téléphone ?!"
...
translate french gaspmina_01_phone_fe44999a:
    ...
    ga nulla "<C'est ce que j'ai dit, ouais ?{w=0.3} Ou peut-être que tu ne connais pas le mot français pour ça ?>"
...
translate french gaspmina_01_phone_5f1449ad:
    ...
    sh angry "Tu as toujours ton téléphone.{w=0.3} {i}Ton propre{/i} téléphone ?!"

# game/scripts/conv/gaspard_amina_convs.rpy:218
...
# game/scripts/conv/gaspard_amina_convs.rpy:219
translate french gaspmina_01_phone_3e0a9807:
    ...
    sh surprise "Non...{w=0.5} Je ne l'ai pas.{w=0.3} Il me le manque actuellement.{w=0.3} Avez-vous déjà essayé de les utiliser ?"

# game/scripts/conv/gaspard_amina_convs.rpy:221
translate french gaspmina_01_phone_e1850ef5:

    # ga nulla "<I have.{w=0.3} Unfortunately, there's no networks available.>"
    ga nulla "<Je l'ai fait.{w=0.3} Malheureusement, il n'y a pas de réseau disponible.>"
...
translate french gaspmina_01_phone_ae83cb01:
    ...
    sh surprise "Même pas pour les appels d'urgence ?{w=0.5} Mais c'est..."
...
translate french gaspmina_01_phone_14e9d7ed:
    ...
    sh frown ".{w=0.3}.{w=0.3}.{w=0.5} Ce n'est pas bon.{w=0.3} Pas bon du tout."
...
translate french gaspmina_01_phone_e9195073:
    ...
    am nulla "Ça n'allait pas à merveille avant...{w=0.5} Mais, à quoi fais-tu référence ?"
...
translate french gaspmina_01_phone_d25cfd84:
    ...
    sh frown "Le fait qu'ils vous aient laissés garder vos téléphones alors qu'ils ont pris le mien...{w=0.5} Les implications ne sont pas charmantes du tout."
...
translate french gaspmina_01_phone_2cc2c47d:
    ...
    sh neutral "Mon téléphone est spécial, pour ainsi dire.{w=0.3} C'est celui que j'utilise pour le travail et, en plus d'avoir un certain nombre de contacts utiles, {nw}"
...
translate french gaspmina_01_phone_cf304a42:
    ...
    sh neutral "Oui.{w=0.3} Il y a très peu d'endroits sur Terre où je ne peux pas l'utiliser, sans parler d'une propriété au milieu de la France."
...
translate french gaspmina_01_phone_e4fb9801:
    ...
    sh frown "Donc, le fait qu'ils aient retiré {i}mon{/i} téléphone spécifiquement alors qu'ils vous ont laissé les vôtres...{w=0.5} implique deux choses.{w=0.3} Premièrement, ils {nw}"
...
translate french gaspmina_01_phone_7bb45820:
    ...
    extend "{b}doivent savoir ce que je fais dans la vie{/b}.{w=0.3} Et deuxièmement..."
...
translate french gaspmina_01_phone_34a8de15:
    ...
    am nulla "Nous laisser nos téléphones n'a aucune conséquence pour celui qui fait ça."
...
translate french gaspmina_01_phone_d7e7ad98:
    ...
    ga nulla "<Très bien, mais calmez vos chevaux.{w=0.3} Tout cela est bien beau, mais il se peut simplement qu'il n'y ait pas de connexion dans cette zone particulière du bâtiment.>"
...
translate french gaspmina_01_phone_332133df:
    ...
    ga nulla "<Des salles de réunion avec des portes verrouillées à sens unique, insonorisées...{w=0.5} Je ne serais pas surpris si l'absence de connexion aussi n'était pas prévue.>"
...
translate french gaspmina_01_phone_57c7087e:
    ...
    ga nulla "<Quoi... ?{w=0.5} Non, je veux dire, tu...>"
...
translate french strings:
    ...
    # game/scripts/conv/gaspard_amina_convs.rpy:33
    old "Shigeo"
    new "Shigeo"
