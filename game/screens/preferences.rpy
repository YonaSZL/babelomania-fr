    ...
    viewport:
        ...
        vbox:
            ...
            hbox:
                ...
                #    style_prefix "radio"
                #    label _("Language")
                #    textbutton _("English") action [Language(None), gui.SetPreference("font", ""interface_font", "gui/font/Klotee.ttf"")] hover_sound "audio/sfx/gui_hover.ogg" activate_sound "audio/sfx/gui_slots_confirm.ogg"
                #    textbutton _("French") action [Language("french"), gui.SetPreference("font", ""interface_font", "gui/font/ColabThi.otf"")] hover_sound "audio/sfx/gui_hover.ogg" activate_sound "audio/sfx/gui_slots_confirm.ogg"
