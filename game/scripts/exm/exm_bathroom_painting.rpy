...
default exm_bathroom_painting_subject = False
default exm_bathroom_painting_title = False
default exm_bathroom_painting_signature = False
...
label exm_bathroom_painting_subject:
    ...
    pause 1.0
    if exm_bathroom_painting_subject == False:
        $ exm_bathroom_painting_subject = True
...
label exm_bathroom_painting_title:
    ...
    if exm_bathroom_painting_title == False:
        $ exm_bathroom_painting_title = True
        $ bathroom_painting_examine += 1
    call screen bathroom_painting_examine
