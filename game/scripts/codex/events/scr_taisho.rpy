screen scr_taisho():
    ...
    add "images/cdx/evs/001_taisho_era.png"
    ...
    text _("""A short period due to the health problems of the Emperor, it is remembered as a transitionary period between the chaotic Meiji period and the more militaristic first part of the Shōwa era, which would see the country veer towards totalitarianism and ultranationalism.""")
