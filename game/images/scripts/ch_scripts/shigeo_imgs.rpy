...
image shigeo_clothes = ConditionSwitch(
...
image shigeo_por_clothes = ConditionSwitch(
    "shigeo_blood == 'None'", "shigeo_por_clothes_full",
    "shigeo_blood == 'blood'", "shigeo_por_clothes_blood"
)
