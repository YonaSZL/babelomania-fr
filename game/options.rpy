...
define config.sample_sound = "audio/sfx/gui_hint.ogg"
...
define config.window_auto_hide = ["scene", "call screen", "menu", "say-centered", "say-bubble", "pause", "call", "hide"]
...
define config.default_music_volume = 0.66
define config.default_sfx_volume = 0.66
define config.default_voice_volume = 0.66
